...
**详细工作流 + C/C++/Rust 模板**：见同目录 loader-engineering.md

**实际技术数据库**（172 项 evasion + 85 组件 + 25 场景）：见同目录 kb/ 三份 JSON
...
**详细工作流 + 各 C2 框架关键检测点**：见同目录 c2-source-evasion.md
...
**详细工作流 + 各语言编译参数**：见同目录 tools-source-evasion.md
...
**详细工作流 + 去重决策表**：见同目录 evasion-research-kb.md
