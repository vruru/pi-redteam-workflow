...
> 完整 C 实现见 [PROCESS_INJECTION.md](./PROCESS_INJECTION.md)；现代变体（Threadless/PoolParty/Process Cloning）
> 见 [modern-injection-variants.md](./modern-injection-variants.md)。
...
> 间接 syscall 全路线（SSN 解析/Halo's Gate/TartarusGate/FreshyCalls/栈伪造/检测侧）
> 见 [ADVANCED_EVASION.md](./ADVANCED_EVASION.md) §1。
